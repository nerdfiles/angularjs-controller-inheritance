...
(() ->
  ...
  MixinWithPrototypicalInheritanceController ($scope) ->
    ...
    # starts growing.
    MixinWithPrototypicalInheritanceController.super_.apply @, arguments
  ...
  angular.forEach inheritance.BaseMixinControllerConstructor.prototype, (value, name) ->
    if p[name] == undefined
      p[name] = value
  ...
  p.setControllerName = () ->
    @$scope.controllerName = 'mixinWithPrototypicalInheritanceController'

  # Override a parent method.
  p.initialize = () ->
    # Call the parent class function.
    MixinWithPrototypicalInheritanceController.super_.prototype.initialize.apply @, arguments
  ...
  #   methods.
  p.mixinPrototypeFunctionsInherited = () ->
